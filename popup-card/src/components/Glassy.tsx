...
const Glassy = () => {
  return (
    <>
      <div className="h-96 w-96 rounded-[4.5rem] bg-gradient-to-b from-[var(--bg-grad-t)] to-[var(--bg-grad-b)] shadow-[inset_4px_4px_8px_-2px_#252525,inset_4px_-4px_8px_-2px_#282828,inset_4px_4px_8px_-2px_#fff,inset_-4px_-4px_8px_-2px_#fff] mx-4">
